      ...
      <div className="bg-white rounded-[35px] shadow-[0px_10px_30px_rgba(99,14,212,0.05)] p-10 md:p-12 w-full max-w-[1150px] flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-[#DEE8FF] rounded-[15px] py-4 pr-4 pl-12 text-[#7B7487] font-['Nunito_Sans'] text-[16px] outline-none focus:ring-2 focus:ring-[#630ED4] transition" 
                placeholder="Judul" 
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-[#DEE8FF] rounded-[15px] py-4 pr-4 pl-12 text-[#7B7487] font-['Nunito_Sans'] text-[16px] outline-none focus:ring-2 focus:ring-[#630ED4] transition" 
                placeholder="Deskripsi singkat game Anda" 
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-[#DEE8FF] rounded-[15px] py-4 pr-4 pl-12 text-[#7B7487] font-['Nunito_Sans'] text-[16px] outline-none focus:ring-2 focus:ring-[#630ED4] transition" 
                placeholder="Masukkan Link Foto 1:1" 
              />
            </div>
          </div>

          {/* Tautan URL File Game */}
          <div className="flex flex-col gap-2">
          ...
          <button 
            type="submit" 
            disabled={isLoading} 
            className="w-full bg-[#630ED4] text-white font-['Quicksand'] font-bold text-[24px] py-4 rounded-[15px] mt-6 hover:bg-[#4800A0] transition disabled:bg-gray-400"
          >
