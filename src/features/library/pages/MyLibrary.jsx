...
// DATABASE DUMMY (Struktur disesuaikan dengan Response GET /api/library)
const DUMMY_LIBRARY = [
  {
    purchaseId: "p1-001",
    purchasedAt: "2026-06-18T10:05:00Z",
    content: {
      id: "c1-001", title: "Petualangan Angka Rimba", thumbnailUrl: null, category: "GAME", subject: "Matematika", gradeLevel: "SD"
    }
  },
  {
    purchaseId: "p1-002",
    purchasedAt: "2026-06-17T14:20:00Z",
    content: {
      id: "c1-002", title: "Detektif Kerajaan Nusantara", thumbnailUrl: null, category: "GAME", subject: "Sejarah", gradeLevel: "SMP"
    }
  },
  {
    purchaseId: "p1-003",
    purchasedAt: "2026-06-15T08:15:00Z",
    content: {
      id: "c1-003", title: "Labirin Kota Penyihir Ajaib", thumbnailUrl: null, category: "INTERACTIVE", subject: "Sains", gradeLevel: "SD"
    }
  }
];
...
export default function MyLibrary() {
  // STATE FILTER (Sama persis dengan Catalog)
  ...
  // FILTERING LOGIC
  const filteredData = DUMMY_LIBRARY.filter((item) => {
    // Karena data dari API dibungkus dalam objek "content", kita akses lewat item.content
    ...
    <div className="p-10 md:p-14 w-full max-w-[1200px] mx-auto">
      ...
      {filteredData.length === 0 ? (
        <div className="text-center py-20 font-['Nunito_Sans'] text-xl text-[#6C778D] flex flex-col items-center">
          ...
          <a href="/catalog" className="text-[#630ED4] font-bold mt-2 hover:underline">Jelajahi Pasar Game</a>
        </div>
      ) : (
